package kz.academycrud.msapar.service;
...
import kz.academycrud.msapar.repository.CoursesRepository;
import kz.academycrud.msapar.repository.UserRepository;
...
public class UserService {
    ...
    public RequestResponse delUserbyid(User user){
        User userToChangeStatus = this.getUserById(user.getId());

        userRepository.delete(userToChangeStatus);
        return RequestResponse.builder().responseCode(0).data(null).message("Delete success!").build();
    }
